...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_m_refSteamVRStatus_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_m_refSteamVRStatus;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWePlayVR_GameInstance_Statics::NewProp_m_refSteamVRStatus_MetaData[] = {
		{ "ModuleRelativePath", "WePlayVR_GameInstance.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UWePlayVR_GameInstance_Statics::NewProp_m_refSteamVRStatus = { "m_refSteamVRStatus", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWePlayVR_GameInstance, m_refSteamVRStatus), Z_Construct_UClass_USteamVRStatus_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UWePlayVR_GameInstance_Statics::NewProp_m_refSteamVRStatus_MetaData, ARRAY_COUNT(Z_Construct_UClass_UWePlayVR_GameInstance_Statics::NewProp_m_refSteamVRStatus_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UWePlayVR_GameInstance_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWePlayVR_GameInstance_Statics::NewProp_m_refSteamVRStatus,
